...
def Tracker(send_channel):
    ...
    colorDetectionList= {}
    if blueExists:
        colorDetectionList['blueX']=finalBlueX
        colorDetectionList['blueY']=finalBlueY

    if greenExists:
        colorDetectionList['greenX']=finalGreenX
        colorDetectionList['greenY']=finalGreenY

    if redExists:
        colorDetectionList['redX']=finalRedX
        colorDetectionList['redY']=finalRedY
    ...
    if greenExists and redExists:
        ...
        colorDetectionList['Red To Green']=angleInDegrees
    ...
    while camera.isOpened():
        ...
        if blueFound:
            ...
            colorDetectionList['blueX']=coordinateBlueY
            colorDetectionList['blueY']=coordinateBlueX
        if greenFound:
            ...
            colorDetectionList['greenX']=coordinateGreenY
            colorDetectionList['greenY']=coordinateGreenX
        # if pinkFound:
        ...
        if redFound:
            ...
            colorDetectionList['redX']=coordinateRedY
            colorDetectionList['redY']=coordinateRedX 
       ...
       #  print("Dictionary: ")
       #  for item in colorDetectionList:
       #      print item, ': ', colorDetectionList[item]
